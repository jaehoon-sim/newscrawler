...
song_detail_list = []
for idx, song in enumerate(song_list,1): # 결과가 매번 100개씩출력되어서 3순위까지 임시로 슬라이싱
    ...
    if res.ok:
        ...
        song_coverImg = soup.select_one("#downloadfrm > div > div > div.thumb > a > img")['src']
        ...
        # if song_coverImg:
        #     song_detail_dict['앨범재킷'] = song_coverImg[0].text
